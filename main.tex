...
Abaixo, faz-se referência à Carta de Convite oficial emitida pela \textit{University of North Florida}, assinada pela Dra. Sherry O. Pinkstaff e pelo Prof. Dr. Guilherme Manna Cesar, confirmando o aceite da aluna Anna Carolina Magalhães Leonel para o estágio BEPE no \textit{Laboratory of Applied Biomechanics and Engineering} (LABE) durante o período de 29 de junho a 29 de dezembro de 2026.

% Nota: O arquivo PDF da carta pode ser incluído fisicamente no documento final usando o comando:
% \includepdf[pages=-]{Invitation_Letter_FAPESP_BEPE_Anna_Leonel.pdf}
% (Requer o pacote pdfpages no preâmbulo)
\end{appendices}
